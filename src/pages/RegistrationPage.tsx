                    ...
                    <input
                      ...
                      className={`appearance-none rounded-md relative block w-full px-4 py-3 border ${
                        formErrors.password
                          ? "border-red-500"
                          : "border-gray-300 dark:border-slate-700"
                      } placeholder-gray-500 dark:placeholder-slate-400 text-gray-900 dark:text-slate-50 bg-white dark:bg-slate-800 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 dark:focus:ring-offset-slate-900 sm:text-base pr-10`}
                    />
                    <button
                      type="button"
              ...
              <div className="grid grid-cols-2 gap-4">
                <div>
                  <button
                    type="button"
                    onClick={() =>
                      console.log("Register with Google placeholder")
                    } // Placeholder action
                ...
                <div>
                  <button
                    type="button"
                    onClick={() =>
                      console.log("Register with Facebook placeholder")
                    } // Placeholder action
