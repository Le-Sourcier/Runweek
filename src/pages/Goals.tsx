...
export default function Goals() {
  ...
  const handleOpenAddModal = (
    suggestion?: Omit<UserGoal, "id" | "current" | "completed" | "deadline"> & {
      deadline?: string;
    }
  ) => {
    if (suggestion) {
      ...
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
        <div>
          ...
          <p className="text-muted-foreground">
            Track your progress and set new targets
          </p>
        </div>
          ...
          <div className="col-span-1 md:col-span-3 flex flex-col justify-center p-4 bg-background rounded-lg">
            ...
            <div className="mt-3 flex flex-wrap gap-2">
              {Object.keys(categoryIcons).map((catKey) => (
                ...
                >
                  {categoryIcons[catKey as GoalCategory]}{" "}
      ...
      <div>
        ...
        {activeGoals.length > 0 ? (
            ...
            {activeGoals.map((goal, index) => (
              ...
              >
                <Card className="h-full bg-card text-card-foreground border-border flex flex-col">
                  ...
                  <h3 className="font-semibold text-lg mt-2 text-foreground">
                    {goal.title}
                  </h3>
                  {goal.description && (
                    <p className="text-muted-foreground text-sm mt-1 flex-grow mb-3">
                      {goal.description}
                    </p>
                  )}
                  ...
                  <div className="mt-auto">
                    ...
                    <div className="flex justify-end gap-1 border-t border-border pt-2 mt-2">
                      <button
                        ...
                        className="btn btn-ghost btn-sm text-green-500 hover:bg-green-500/10 p-1.5"
                      >
                        <CheckCircle size={16} />
                      </button>
                      <button
                        onClick={() => handleOpenEditModal(goal)}
                        className="btn btn-ghost btn-sm text-blue-500 hover:bg-blue-500/10 p-1.5"
                      >
                        <Edit2 size={16} />
                      </button>
                      <button
          ...
          <Card className="bg-card text-card-foreground border-border py-8 text-center">
            ...
            <p className="text-muted-foreground">
              No active goals. Set some new targets!
            </p>
          </Card>
        )}
      </div>
            ...
            >
              {(() => {
                ...
                return (
                  ...
                  >
                    {categoryIcons[currentSuggestionCategory]}{" "}
          ...
          {completedGoals.length > 0 ? (
            <div className="divide-y divide-border">
              {completedGoals.map(
                (
                  goal,
                  index // Added index for animation
                ) => (
                  <motion.div
                    key={goal.id}
                  ...
                  >
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-muted-foreground">
                          ...
                          {/* Assuming deadline is completion date for now */}
                        </p>
                      </div>
                    </div>
                    <div className="flex items-center gap-2">
                      ...
                      <button
                        onClick={() => handleToggleComplete(goal)}
                        className="btn btn-ghost btn-sm text-amber-500 hover:bg-amber-500/10 p-1.5"
                        title="Reopen Goal"
                      >
                        <RotateCcw size={16} />
                      </button>
            ...
            <div className="p-6 text-center">
              ...
              <p className="text-muted-foreground mb-4">
                Keep working toward your targets!
              </p>
            </div>
          )}
        </Card>
