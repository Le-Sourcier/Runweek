                  ...
                  <div className="flex justify-between items-start">
                    <Badge
                      variant={
                        ...
                        goal.category === 'consistency' ? 'warning' :
                        goal.category === 'event' ? 'destructive' : 'default'
                      }
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          {goalSuggestions.map((suggestion) => (
            ...
            >
              <Badge
                variant={
                  suggestion.category === 'distance' ? 'primary' :
                  suggestion.category === 'speed' ? 'secondary' :
                  suggestion.category === 'consistency' ? 'warning' :
                  suggestion.category === 'event' ? 'destructive' : 'default'
                }
                className="mb-2 flex items-center gap-1 inline-flex text-xs self-start"
              >
                {categoryIcons[suggestion.category]} {suggestion.category.charAt(0).toUpperCase() + suggestion.category.slice(1)}
              </Badge>
