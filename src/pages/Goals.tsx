...
export default function Goals() {
  ...
  const [newGoalCategory, setNewGoalCategory] =
    useState<GoalCategory>("distance");
  ...
  const handleSaveNewGoal = (event: React.FormEvent) => {
    ...
    if (
      ...
      alert(
        "Please fill in all required fields: Title, Category, Target, Unit, and Deadline."
      );
      return;
    }
                    ...
                    <Badge
                      variant={
                        goal.category === "distance"
                          ...
                          ? "warning"
                          : "destructive" // Using destructive for event as an example
                      }
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          {goalSuggestions.map((goal) => (
            ...
            >
              ...
              >
                {categoryIcons[goal.category as GoalCategory]}{" "}
