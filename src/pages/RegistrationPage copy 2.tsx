    ...
    <div className="flex items-center justify-center w-full h-screen bg-gray-100 p-4">
      ...
      <div className="relative flex w-full max-w-6xl h-full bg-white rounded-3xl overflow-hidden shadow-xl">
        ...
        >
          ...
          <div className="absolute bottom-6 left-6 z-20 flex items-center justify-between w-full space-x-4">
            {/* Vignette de profil */}
            <div className="flex items-center space-x-3 hover:animate-none animate-bounce transform transition-all duration-300 cursor-pointer">
              <img
            ...
            <div className="flex space-x-2 -translate-x-12">
