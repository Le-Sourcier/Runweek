...
//     currentDayNutrition?.waterIntake || 0
//   );
//   const [dailyNotes, setDailyNotes] = useState(
//     currentDayNutrition?.notes || ""
//   );
...
//   const suggestions = currentDayNutrition
//     ? getFoodSuggestions(selectedMealType, currentDayNutrition)
//     : [];
...
//                   {Math.round(dietStats.weeklyCaloriesAvg)}
//                 </span>
//               </div>
//               <div className="flex justify-between items-center">
//                 <span className="text-sm text-muted-foreground">
...
//                 </span>
//                 <span className="font-semibold text-foreground">
//                   {Math.round(dietStats.weeklyProteinAvg)}g
//                 </span>
//               </div>
//               <div className="flex justify-between items-center">
//                 <span className="text-sm text-muted-foreground">
