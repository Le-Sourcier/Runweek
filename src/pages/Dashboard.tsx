...
import { Heart, Activity, Moon, Footprints, Calendar, Trophy, ArrowRight, PlusCircle, Sunrise, MessageSquare } from 'lucide-react'; // Added PlusCircle, Sunrise, MessageSquare
    ...
    <div className="space-y-6">
      ...
      <Card title="Test Notifications & Achievements">
        <div className="flex flex-col space-y-3 sm:flex-row sm:space-y-0 sm:space-x-3">
          <button
            onClick={() => {
              if (userContext.unlockSpecificAchievement) {
                ...
                const currentAchievements = userContext.user?.achievements || [];
                const achievementIdToUnlock = "a3";
                const isAlreadyUnlocked = currentAchievements.some(ach => ach.id === achievementIdToUnlock);
          ...
          <button
            onClick={() => {
              toast.info("New message from Coach AI: Check your updated training plan!");
