...
export default function ConnectedDevicesSettings({
  ...
  const handleRevokeDevice = (deviceId: string) => {
    ...
    if (user) {
      ...
      console.log(
        `Device ${deviceId} revoked. New device list:`,
        updatedDevices
      );
    ...
    >
      ...
      <div className="mt-6 pt-6 border-t border-border flex justify-center">
        <button
          ...
          className="btn btn-outline dark:border-muted dark:text-muted-foreground dark:hover:bg-muted/20 flex items-center gap-2"
        >
          <PlusCircle size={18} />
          Add New Device
        </button>
